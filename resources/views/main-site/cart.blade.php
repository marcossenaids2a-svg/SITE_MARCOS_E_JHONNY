    ...
    <div class="container"><!-- STRART CONTAINER -->
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">começo</a></li>
                ...
                <div class="cart_totals">
                    ...
                    @else
                        <div class="alert alert-warning mt-3 mb-3">
                            Você precisa fazer login ou se registrar para completar seu pedido.
                        </div>
                        <div class="d-grid gap-2 d-md-flex">
                            <a href="{{ route('auth.login') }}" class="btn btn-default">Login</a>
                            <a href="{{ route('customer.account.create') }}" class="btn btn-default">Registrar</a>
                        </div>
                    @endif
                </div>
        ...
        <div class="row" id="empty-cart">
            <div class="col-12">
                <div class="alert alert-secondary text-center" role="alert">
                    ...
                    <p> Parece que você ainda não adicionou nenhum item ao seu carrinho. Sem preocupação, temos muitas opções deliciosas esperando por você.</p>
                    <hr>
                    <p class="mb-0">Vá até nosso <a href="{{ route('menu') }}" class="alert-link">cardápio</a> e comece a explorar!</p>
                </div>
            </div>
        </div>
    </div>
