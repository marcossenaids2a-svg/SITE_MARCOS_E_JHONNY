                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="banner_content2 text_white">
                                    <h2 class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.2s">Delícias Africanas Saborosas</h2>
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">Viva a experiência dos sabores vibrantes da África com pratos preparados com perfeição. <br class="d-none d-md-block" /> Each bite takes you closer to tradition and joy.</p>
                                    <a class="btn btn-default rounded-0 staggered-animation" href="{{ route('menu') }}" data-animation="fadeInUp" data-animation-delay="0.6s">Pedidos Online</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- END CONTAINER-->
                    ...
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-md-12 col-sm-12 text-center">
                                <div class="banner_content2 text_white">
                                    <h2 class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.2s">Escolha e Saboreie</h2>
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">Delicie-se com o suya e outros pratos de dar água na boca, infundidos com especiarias autênticas <br class="d-none d-md-block" /> and crafted to delight your taste buds.</p>
                                    <a class="btn btn-default rounded-0 staggered-animation" href="{{ route('menu') }}" data-animation="fadeInUp" data-animation-delay="0.6s">Pedidos Online</a>
                                    <a class="btn btn-white rounded-0 staggered-animation" href="{{ route('contact') }}" data-animation="fadeInUp" data-animation-delay="0.6s">Fale conosco</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- END CONTAINER-->
                    ...
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row justify-content-md-end">
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="banner_content2 text_white">
                                    <h4 class="staggered-animation text_default" data-animation="fadeInUp" data-animation-delay="0.2s">Vocês estão prontos?</h4>
                                    <h2 class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.2s">Aproveite cada mordida</h2>
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">Do suya fumegante aos ensopados fartos, desfrute de pratos africanos feitos para trazer alegria <br class="d-none d-md-block" /> Para todas as ocasiões e apetites.</p>
                                    <a class="btn btn-default rounded-0 staggered-animation" href="{{ route('menu') }}" data-animation="fadeInUp" data-animation-delay="0.6s">Pedidos Online</a>
                                    <a class="btn btn-white rounded-0 staggered-animation" href="{{ route('contact') }}" data-animation="fadeInUp" data-animation-delay="0.6s">Fale conosco</a>
                                </div>
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="heading_s1 animation text-center" data-animation="fadeInUp" data-animation-delay="0.02s">
                        <div class="sub_heading font_style1">Especialidades</div>
                        <h2>do Nosso Cardápio</h2>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        @empty
                        <b> Nenhum item disponível no momento. </b>
                        @endforelse                       
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-7 col-md-9 animation text-center" data-animation="fadeInUp" data-animation-delay="0.02s">
                <div class="heading_s1 heading_light">
                    <span class="sub_heading font_style1">Viva o Sabor Verdadeiro</span>
                    <h2>Onde as Refeições Nos Unem</h2>
                </div>
                <p class="text-white">Celebre a alegria de jantar com pratos africanos autênticos, preparados para aproximar famílias e amigos a cada mordida.</p>
                <a class="btn btn-white rounded-0" href="{{ route('menu') }}">Peça Agora</a>
                            ...
                            <div class="col-lg-7 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                                <div class="book_table">
                                    ...
                                    <div class="heading_s1 mb-md-0">
                                        <span class="sub_heading font_style1">Reservas</span>
                                    ...
                                    <div class="field_form form_style1">
                                        <form method="post" action="{{ route('table.booking') }}" name="enq">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="submit" title="Submit Your Message!" class="btn btn-default rounded-0" name="submit" value="Submit">Reservar Agora</button>
                                                </div>
                                            </div>
                                        </form>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                <div class="heading_s1 text-center">
                    <span class="sub_heading font_style1">Depoimentos</span>
                    <h2>Os Nossos Clientes Dizem!</h2>
                </div>
                <p class="text-center leads">Ouça o que nossos clientes felizes têm a dizer sobre sua experiência conosco.</p>
            </div>
        </div>
        <div class="row justify-content-center">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                <div class="heading_s1 text-center">
                    <span class="sub_heading font_style1">Do Blog</span>
                    <h2>Notícias Recentes</h2>
                </div>
                <p class="text-center leads">Confira as últimas notícias e atualizações do nosso blog.</p>
            </div>
        </div>
        <div class="row justify-content-center">
