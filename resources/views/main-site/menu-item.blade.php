                ...
                <div class="pr_detail">
                    <div class="product_description">
                        ...
                        <ul class="product-meta">
                            <li>Categoria:  {{ $menu->category->name }}</li>
                        </ul>
                    </div>
                    <hr />
                    <div class="cart_extra">
                        ...
                        <div class="cart_btn">
                            <button data-id="{{ $menu->id }}"
                                ...
                                type="button"  class="{{ $quantity==0 ? '':'d-none' }} btn btn-default rounded-0 add-to-cart"  >Adicionar ao Carrinho</button>
