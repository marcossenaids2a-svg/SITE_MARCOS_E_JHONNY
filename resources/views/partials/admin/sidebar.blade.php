        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <li class="nav-item {{ Request::is('admin/order*') ? 'active-nav' : '' }}">
            <a class="nav-link" href="{{ route('admin.orders.index') }}">
                ...
                <span class="menu-title">Manter Pedidos</span>
            </a>
        </li>
        ...
        <li class="nav-item {{ request()->route()->named('admin.users.index') ? 'active-nav' : '' }}">
          <a class="nav-link" href="{{ route('admin.users.index') }}">
              ...
              <span class="menu-title">Manter Admins</span>
          </a>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="site-settings" style="">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.testimonies.index') }}">Testemunhos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.terms.edit') }}">Termos e Condições</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.privacy-policy.edit') }}">Política de Privacidade</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.general-settings') }}">Configurações Gerais</a>
                    </li>
                </ul>
            </div>
        </li>
        @endif
              ...
              <li class="nav-item">
                <a target="_blank" class="nav-link" href="{{ route('home') }}">
                  ...
                  <span class="menu-title">Site Principal</span>
                </a>
              </li>
